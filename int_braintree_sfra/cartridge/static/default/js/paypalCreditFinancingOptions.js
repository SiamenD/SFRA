...
(function () {
    function updateLabelValues() {
        document.querySelectorAll('.js_paypal_fo_lower_price_label:not(.js_paypal_fo_lower_price_label_inited)').forEach(function (el) {
            var $label = $(el);
    ...
    $(function () {
        ...
        function updateBanner(url) {
            $.ajax(url).done(function (data) {
                ...
                document.querySelectorAll('.js_paypal_fo_allOptionsBanner_tab_content').forEach(function (el) {
                    var $tabContent = $(el);
