...
creditFinancialOptionsHelper.isAllowedForMerchant = function () {
    ...
    logger.error('Using PayPal Credit Financial Options is not allowed. Need to set "PayPal Credit Financial Options Password" field in BM > ' + siteId + ' > Merchant Tools > Site Preferences > Custom Site Preference > BRAINTREE_PAYPAL');
    return false;
};
